class PlayerArrow {
  constructor(x, y, width, height, archerAngle) {
    ...
    this.tImage = loadImage ("./assets/Arrow-trajectoryIMG.png");
  ...
  display() {
    ...
    if (this.body.velocityX > 0 && pos.x > playerArcher.body.position.x) {
    ...
    for (var i = 0; i < this.trajectory.length; i++) {
      imageMode (CENTER);
      image (this.tImage, this.trajectory [i][0], this.trajectory [i][1], 10, 10);
    }
  }
}